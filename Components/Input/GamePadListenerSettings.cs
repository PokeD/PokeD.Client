...
namespace PokeD.CPGL.Components.Input
{
    ...
    public class GamePadListenerSettings
    {
        public GamePadListenerSettings() : this(PlayerIndex.One) { }
        ...
        ///     through this listener.
        /// </param>
        public GamePadListenerSettings(PlayerIndex playerIndex, bool vibrationEnabled = true, float vibrationStrengthLeft = 1.0f, float vibrationStrengthRight = 1.0f)
        {
