...
{
    public class ScaleHQx2Effect : Effect
    {
        public static ScaleHQx2Effect Load(ContentManager content) => new ScaleHQx2Effect(content.Load<Effect>("Shaders/ScaleHQx2"));
        ...
        public ScaleHQx2Effect(Effect cloneSource) : base(cloneSource)
        {
            CacheEffectParams();
        ...
        public ScaleHQx2Effect(ScaleHQx2Effect cloneSource) : base(cloneSource)
        {
            CacheEffectParams();
        ...
        public ScaleHQx2Effect(GraphicsDevice graphicsDevice) : base(graphicsDevice, null)
        {
            CacheEffectParams();
        }
        ...
        {
            return new ScaleHQx2Effect(this);
        }
    }
}
