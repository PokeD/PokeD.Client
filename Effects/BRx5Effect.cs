...
{
    public class BRx5Effect : Effect
    {
        public static BRx5Effect Load(ContentManager content) => new BRx5Effect(content.Load<Effect>("Shaders/BRx5"));
        ...
        public BRx5Effect(Effect cloneSource) : base(cloneSource)
        {
            CacheEffectParams();
        ...
        public BRx5Effect(BRx5Effect cloneSource) : base(cloneSource)
        {
            CacheEffectParams();
        ...
        public BRx5Effect(GraphicsDevice graphicsDevice) : base(graphicsDevice, null)
        {
            CacheEffectParams();
        }
